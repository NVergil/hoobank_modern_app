...
const Footer = () => (
  <section className={`${styles.flexCenter} sm:py-10 py-6 flex-col ${styles.boxWidth} ${styles.paddingX}`}>
    ...
    <div className="w-full flex justify-between items-center md:flex-row flex-col pt-6 border-t-[1px] border-t-[#3f3e45]">
      <p className="font-poppins font-normal text-center text-[18px] leading-[27px] text-white opacity-[0.6]">
